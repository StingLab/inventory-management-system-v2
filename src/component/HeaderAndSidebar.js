...
function HeaderAndSidebar(props) {
    ...
    const selectedItem = "relative px-4 py-3 flex items-center space-x-4 rounded-xl text-white bg-gradient-to-r from-sky-600 to-cyan-400";
    const nonSelectedItem = "px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 group";
    return (
        <div>
            ...
            <div>
                ...
                <ul className="space-y-2 tracking-wide mt-8">
                    <li>
                        <Link to="#" aria-label="dashboard" className={selection ? nonSelectedItem : selectedItem} onClick={() => setSelection(!selection)}>
                    ...
                    <li>
                        <Link to="#"  className={selection? selectedItem: nonSelectedItem} onClick={()=>setSelection(!selection)}>
                    ...
                    <li>
                        <Link to="#" className={selection ? nonSelectedItem : selectedItem} onClick={() => setSelection(!selection)}>
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                            ...
                            <span className="group-hover:text-gray-700">Entry</span>
                        </Link>
                    </li>
                    <li>
                        <Link to="#" className={selection ? nonSelectedItem : selectedItem} onClick={() => setSelection(!selection)}>
                            ...
                            <span className="group-hover:text-gray-700">Sell</span>
                        </Link>
                    </li>
                    <li>
                        <Link to="#" className={selection ? nonSelectedItem : selectedItem} onClick={() => setSelection(!selection)}>
                            ...
                            <span className="group-hover:text-gray-700">Setup</span>
                        </Link>
                    </li>
                </ul>
            </div>
