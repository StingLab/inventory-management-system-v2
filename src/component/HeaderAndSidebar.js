...
function HeaderAndSidebar(props) {
    ...
    const selectedClass = "px-4 py-3 flex items-center space-x-4 rounded-xl text-white bg-gradient-to-r from-sky-600 to-cyan-400";
    const nonSelectedClass = "px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 group";
    const dashboardMenu = [
        {
            id : 1,
            name : 'Dashboard',
